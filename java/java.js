...
let homel = document.querySelector("#homel");
let homeg = document.querySelector("#homeg");
let muted = false;
let soundvolume = .5;
...
function userStart() {
    ...
    lives = 3;
    document.querySelector("#hearts_1").style.display = "block";
...
document.querySelector("#game").classList.add("blur");
    ...
    document.querySelector("#setting_container").style.display = "block";
    homes.addEventListener("click", goUstart);
...
function levelComplete() {
    ...
    homel.addEventListener("click", goUstart);
    soundlevel.addEventListener("ended", levcompletesound);
    timeLeft = 20;
}

function levcompletesound() {
    soundlevel.play();
}
...
function gameOver() {
    ...
    //
    homeg.addEventListener("click", goUstart);
...
function gameRestart() {
    ...
    document.querySelector("#gameover_container").style.display = "none";
